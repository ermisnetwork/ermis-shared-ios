...
enum MessageReactionsBubbleTail {
    struct Options {
...
extension UIImage {
    static func tail(
        options: MessageReactionsBubbleTail.Options,
        colors: MessageReactionsBubbleTail.Colors
    ) -> UIImage {
...
private extension MessageReactionsBubbleTail.Options {
