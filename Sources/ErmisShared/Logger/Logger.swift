...
public enum LogConfig {
    ...
    nonisolated(unsafe) public static var destinations: [LogDestination] {
        get {
    ...
    nonisolated(unsafe) private static var queue = DispatchQueue(label: "network.ermis.logconfig")
